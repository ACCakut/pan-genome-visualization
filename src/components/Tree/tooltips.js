  ...
  d3.selectAll(divID)
    .on('mouseover', function (d) {
      ...
      if (tooltip.text() != '') {
        ...
        //** for cluster-table: hidden header of expand button
  ...
  .html(function (d) {
    ...
    if (d.name != undefined) {
      if (d.n.accession == undefined) {
        ...
        string +=
          " <tr> <th class='tooltip_table_th'>NCBI accession</th> <td class='tooltip_table_td'> " +
          d.name +
          ' </td> </tr> '
      } else {
        string +=
          ...
          ' </td> </tr> '
        string +=
          " <tr> <th class='tooltip_table_th'>gene ID</th> <td class='tooltip_table_td'> " + d.name + ' </td> </tr> '
      }
    }
    ...
    for (var i = 0, len = meta_types.length; i < len; i++) {
      ...
      if (antibiotics_set && antibiotics_set.indexOf(meta_category) >= 0) {
        ...
        if (
          typeof d.n.attr != 'undefined' &&
          typeof d.n.attr[meta_category] != 'undefined' &&
          d.n.attr[meta_category] != 'unknown'
        ) {
          string +=
            " <tr> <th class='tooltip_table_th'>" +
            meta_category +
            "</th> <td class='tooltip_table_td'> " +
            d.n.attr[meta_category] +
            ' </td> </tr> '
        }
      }
    }
    ...
    if (antibiotics_set) {
      ...
      for (var i = 0; i < antibiotics_set.length; i++) {
        if (
          d[antibiotics_set[i]] != 'unknown' &&
          d[antibiotics_set[i]] != 'Susceptible' &&
          typeof d[antibiotics_set[i]] != 'undefined'
        ) {
    ...
    if (typeof d.n.annotation != 'undefined') {
      string +=
        " <tr> <th class='tooltip_table_th'>annotation</th> <td class='tooltip_table_td'> " +
        d.n.annotation +
        ' </td> </tr> '
    }
    if (typeof d.n.muts != 'undefined') {
      const na_muts = d.n.muts,
        na_muts_len = na_muts.length
      if (na_muts_len !== 0) {
        const na_muts_str = na_muts_len > 25 ? na_muts.substr(0, 25) + '...' : na_muts
        string +=
          " <tr> <th class='tooltip_table_th'>nucleotide mutations:</th> <td class='tooltip_table_td'> " +
          na_muts_str +
          ' </td> </tr> '
      }
    }
    if (typeof d.n.aa_muts != 'undefined') {
      const aa_muts = d.n.muts,
        aa_muts_len = aa_muts.length
      if (aa_muts_len !== 0) {
        const aa_muts_str = aa_muts_len > 25 ? aa_muts.substr(0, 25) + '...' : aa_muts
        string +=
          " <tr> <th class='tooltip_table_th'>amino acid mutations:</th> <td class='tooltip_table_td'> " +
          aa_muts_str +
          ' </td> </tr> '
      }
    }
...
export const tooltip_branch = d3
  .tip()
  .attr('class', 'd3-tip')
  .html(function (d) {
    var string = ''
    ...
    if (d.n) {
      ...
      if (typeof d.n.muts != 'undefined') {
        ...
        if (muts_str.length > 50) {
          muts_str = muts_str.substr(0, 50) + '...'
        }
        string += '<br/>' + 'nucleotide mutations:  ' + muts_str
      }
      if (typeof d.n.aa_muts != 'undefined') {
        var aa_muts_str = d.n.aa_muts
        if (aa_muts_str.length > 50) {
          aa_muts_str = aa_muts_str.substr(0, 50) + '...'
        }
...
export const append_download_button = function (divID, buttonId, href_link) {
  d3.select(divID).append('span').style('display', 'inline-block').style('width', '6px')
  d3.select(divID)
    .append('a')
    .attr('href', href_link)
    .append('i')
